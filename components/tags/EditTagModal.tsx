...
import { getTypeDisplayName, getDefaultValueByType, RESERVED_VARIABLE_NAMES, isVariableNameLengthValid } from "@/components/tags/tagUtils";
                    ...
                    <>
                        ...
                        <ModalBody>
                            ...
                            >
                                ...
                                {/* 权重输入框 - 仅对角色和元素类型显示 */}
                                {(editingTag.type === "character" || editingTag.type === "element") && (
                                    <div>
