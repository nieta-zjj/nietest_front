...
export default function Home() {
  ...
  const [selectedTab, setSelectedTab] = useState<string>("parameters");
  return (
      ...
      <Card className="w-full max-w-3xl relative">
        ...
        <CardHeader className="flex flex-col gap-1 items-center pt-10">
          ...
          <h2 className="text-xl font-medium">
            {selectedTab === "parameters" && "测试参数"}
            {selectedTab === "progress" && "任务进度"}
            {selectedTab === "history" && "历史记录"}
          </h2>
        ...
        <CardBody>
          {selectedTab === "parameters" && <DraggableTags />}
